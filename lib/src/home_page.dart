...
class CartItem {
  ...
  CartItem(this.productId, this.price, this.num);

  CartItem incrementNum() {
    return CartItem(productId, price, num + 1);
  }

  CartItem decrementNum() {
    return CartItem(productId, price, num - 1 < 0 ? 0 : num - 1);
  }
...
class _SampleListPageState extends State<SampleListPage>
  ...
  late List<HotelListData> hotelList;
