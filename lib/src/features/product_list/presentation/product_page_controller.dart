...
final productPageControllerProvider =
    StateNotifierProvider.autoDispose<ProductPageController, AsyncValue<void>>((ref) {
...
class ProductPageController extends StateNotifier<AsyncValue<void>> {
  ...
  Future<void> addCart({required Product product, required int num, required VoidCallback onSuccess}) async {
